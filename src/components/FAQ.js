                ...
                <div id = "FAQBoxesContainer">
                    <div id ="FAQBoxesGrid">
                        <div className="row">
                            ...
                            <div class="FAQItem">
                                <FAQBox question={"What if I don't have an idea or team?"} answer={"There are plenty of other hackers with your same dilemma that you can join forces with. Thirty six hours is plenty of time for a couple hours of brainstorming. Also, we will have team building and idea brainstorming workshops."}/>
                            </div>
                            <div class="FAQItem">
                            ...
                            <div class="FAQItem">
                                <FAQBox question={"How much does it cost?"} answer={"Nothing. Food, drinks, power, building materials, and machine time are provided for free."}/>
                            </div>
                            <div class="FAQItem">
